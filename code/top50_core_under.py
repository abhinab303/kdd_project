...
op_file_path = f"/home/aa7514/PycharmProjects/kdd_project/files/emb_tiny_under{l}.npy"
...
for itr in max_iter:
    for cpm in c_param:
        for wt in class_weight:
            ...
            # pdb.set_trace()
            csv_file_path = f"/home/aa7514/PycharmProjects/kdd_project/plots/final/top{l}_core_under_bs.csv"
...
csv_file_path2 = f"/home/aa7514/PycharmProjects/kdd_project/plots/final/top{l}_core_under_cs.csv"
...
plt.show()
plt.savefig(f'/home/aa7514/PycharmProjects/kdd_project/plots/final/top{l}_core_under_cm.pdf', bbox_inches='tight')
